...
public class DefaultFilmServiceImpl implements FilmServiceApi {
    ...
    /**
     * 热映电影,包含首页 film_status为1
     * @param isLimit true表示首页,false表示单独页
     * @param nums pagesize大小
     * @param nowPage 当前页(currentpage)
     * @param sortId 排序字段
     * @param sourceId 地区
     * @param yearId 年代
     * @param catId 类型
    ...
    public FilmVO getHotFilms(boolean isLimit,int nums,int nowPage,int sortId,int sourceId,int yearId,int catId) {
        ...
        if(isLimit){
            ...
            if(catId != 99){//一个影片可能有多种类型,比如喜剧 爱情,用#分割
                // #2#4#22#
                String catStr = "%#"+catId+"#%";
    ...
    /**
     *查询影片基本信息
     * @param searchType searchType 1-按名称  2-按ID的查找
     * @param searchParam 查询关键词
     * @return
     */
    @Override
